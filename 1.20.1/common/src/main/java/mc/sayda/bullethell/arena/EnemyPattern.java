 ...
 * BLUE_FAIRY uses bulletCount=1; Lunatic still reaches ~2 via densityMult,
 * capped in AIMED AI.
...
public enum EnemyPattern {
    ...
    private static final EnemyPattern[] VALUES = values();

    public static EnemyPattern fromId(int id) {
        return (id >= 0 && id < VALUES.length) ? VALUES[id] : AIMED;
    }
