 ...
 * LARGE_FAIRY - mid-wave anchor (any colour), 5-shot burst; uses shared large sprite sheet
 * POLICE_FAIRY / WARRIOR_FAIRY - small-fairy variants with dedicated 160×40 sheets
...
public enum EnemyType {
    ...
    // hp bullets spread bSpd atkIvl score dropType texIdx med? large? hRadius  defaultPattern
    ...
    // Large fairies: aimed burst + outer ring - dual threat (shared large 280×70 sheet)
    ...
    /** Index into small-fairy color sheets (0–5); ignored when {@link #medium} or {@link #large}. */
    public final int textureIdx;
    /** If true, renders from {@code medium_fairy.png} (50×50 × 4). */
    public final boolean medium;
    /**
     * If true the renderer uses {@code large_fairy.png} (70×70 × 4); hitbox stays large.
     */
