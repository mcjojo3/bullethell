...
public enum GameEvent {
    ...
    SCORE_EXTEND,   // extra life from score milestone
    DEATH_BOMB,     // bomb successfully cancelled a pending death (deathbomb)
    BOSS_INTRO;     // boss phase 0 entrance (white flash)
