...
/** C → S: select a boss/stage from the test list, change phase/difficulty, or reload. */
public class TestSelectPacket {
    ...
    public final String id;           // bossId or stageId
    public final int phaseIdx;        // boss only, ignored for stage
